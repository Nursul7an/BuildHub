...
import { AcceptanceScreen, ZayavkaCardScreen, ZayavkaNewScreen, ZayavkiScreen, } from './zayavki/ZayavkiScreens';
import { FleetScreen, TechReportScreen, TechZayavkaScreen } from './zayavki/TechScreens';
import { ContractorCardScreen, ContractorRateScreen, ContractorsScreen, } from './contractors/ContractorScreens';
import { ActsScreen, CurrentSheetsScreen, DocumentsScreen, ObjectDocumentsScreen, ProjectScreen, ProjectSetScreen, RfiScreen, SheetScreen, StrengthScreen, } from './docs/ProjectScreens';
import { AssistantScreen, MoreScreen, NotificationsScreen, ProfileScreen, } from './common/CommonScreens';
import { PtoChainSetupScreen, PtoCheckScreen, PtoLabScreen, PtoObjectScreen, PtoObjectsScreen, PtoQueueScreen, PtoTodayScreen, PtoUserNewScreen, PtoUsersScreen, } from './pto/PtoScreens';
import { BossAssignScreen, BossCompanyObjectsScreen, BossDigestScreen, BossFinanceObjectScreen, BossFinanceScreen, BossInboxScreen, BossKpiScreen, BossLimitsScreen, BossObjectScreen, BossObjectsScreen, BossQualityScreen, BossWeekScreen, PlanerkaScreen, } from './boss/BossScreens';
import { BossTasksScreen } from './boss/BossTasksScreen';
import { AssignedWorksScreen, OnboardingBlocksScreen, OnboardingSectionsScreen, } from './onboarding/OnboardingScreens';
import { DepartmentMoreScreen, IssueScreen, MaterialsTodayScreen, MaterialsZayavkiScreen, StockScreen, TechQueueScreen, TechTodayScreen, } from './materials/MaterialScreens';
const SCREENS = {
    // вход
    login: LoginScreen,
...
export function renderScreen(screen, _params) {
    const Component = SCREENS[screen];
    if (!Component)
        return _jsx(NotBuilt, { screen: screen });
    return _jsx(Component, {});
}
function NotBuilt({ screen }) {
    return (_jsxs(ScreenBody, { style: { padding: 24, color: color.muted, gap: 8 }, children: [_jsx("div", { style: { fontSize: 16, fontWeight: 800, color: color.ink }, children: "\u042D\u043A\u0440\u0430\u043D \u0435\u0449\u0451 \u043D\u0435 \u0441\u043E\u0431\u0440\u0430\u043D" }), _jsx("div", { style: { fontSize: 13 }, children: screen })] }));
}
